...
redgarnotelogo = Image.open("C:/Users/bedga/PycharmProjects/facesecuritynotepad/rnotelogowriting.png")
...
class Notepad:
    ...
    __root.wm_attributes("-topmost", 1)  # Solution to Eric's question on keeping his window open above all other windows
    ...
    def __showAbout(self):
        showinfo("Notepad", "Version 1.0. Body program by MrinalVerma. Security and Additional Integration by Edgar B.")
